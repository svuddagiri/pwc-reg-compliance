...
class Settings(BaseSettings):
    ...
    search_top_k: int = Field(default=10, description="Number of top results to retrieve")
    search_min_score: float = Field(default=0.7, description="Minimum relevance score")
